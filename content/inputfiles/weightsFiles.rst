...
.. figure:: images/interface_weights_input.png
     ...
     Example input file for creating interface weights (`Download <https://github.com/ubcgif/e3d/raw/e3d/assets/e3d_input/interface_weights.inp>`__ ).
...
.. _e3d_face_weight_ln4:
    ...
    - **Mapping Type:** Here, the user specifies whether the mapping between the model value and the physical property value on the mesh is linear or logarithmic. To specify, use the flags "LIN_MODEL" or "LOG_MODEL". In the case of e3d, the inversion recovers the log-conductivity. As a result, the user should use "LOG_MODEL".
